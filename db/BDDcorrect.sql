...
(4, 8, 'Vous avez tué le sanglier'),
(4, 10, 'Vous êtes mort face au sanglier'),
(5, 7, 'Après avoir écouté le paysan'),
(6, 7, 'Vous avez survécu au loup'),
(6, 10, 'Vous êtes mort face au loup'),
...
(11,10, 'Vous êtes mort empoisonné par la pierre gravée'),
(12,13, 'Montez l''escalier à la hâte'),
(12,14, 'Avancez prudemment, prêt à dégainer votre arme'),
(13,15, 'Vous avez gagné le combat contre le squelette'),
(13,10, 'Vous êtes mort face au squelette'),
...
(17,19, 'Vous avez gagné le combat contre la gargouille'),
(17,10, 'Vous êtes mort face à la gargouille'),
...
(27,29, 'Vous avez gagné le combat contre l''esprit élémentaire'),
(27,10, 'Vous êtes mort face à l''esprit élémentaire'),
