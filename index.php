...
$router->addRoute('manage_treasures/store', 'AdminController@storeTreasure');
$router->addRoute('manage_treasures/edit', 'AdminController@editTreasure');
$router->addRoute('manage_treasures/update', 'AdminController@updateTreasure');
$router->addRoute('manage_treasures/delete', 'AdminController@deleteTreasure');
